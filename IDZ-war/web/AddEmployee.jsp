...
<html>
    ...
    <body>
        ...
        <form method="post" onsubmit="return validateForm()">
            ...
            <div>
                <label for="hiringDate">Дата найму:</label>
                <input type="date" id="hiringDate" name="hiringDate">
            </div>

            <div>
                <label for="contractStartDate">Початок контракту:</label>
                <input type="date" id="contractStartDate" name="contractStartDate">
            </div>

            <div>
                <label for="contractEndDate">Кінець контракту:</label>
                <input type="date" id="contractEndDate" name="contractEndDate">
            </div>

            <div>
                <label for="prevVacationStartDate">Початок попередньої відпустки:</label>
                <input type="date" id="prevVacationStartDate" name="prevVacationStartDate">
            </div>

            <div>
                <label for="prevVacationEndDate">Кінець попередньої відпустки:</label>
                <input type="date" id="prevVacationEndDate" name="prevVacationEndDate">
            </div>

            <div>
                <label for="nextVacationStartDate">Початок наступної відпустки:</label>
                <input type="date" id="nextVacationStartDate" name="nextVacationStartDate">
            </div>

            <div>
                <label for="nextVacationEndDate">Кінець наступної відпустки:</label>
                <input type="date" id="nextVacationEndDate" name="nextVacationEndDate">
            </div>
